<?php
/**
 * File: api/payment-callback/vnpay.php
...
// Xác thực callback
$verifyResult = $gatewayService->verifyVNPayCallback($vnpData);
        ...
        if ($verifyResult['transaction_status'] === 'success') {
            ...
            if ($check_enrollment->rowCount() == 0) {
                ...
                try {
                    ...
                    error_log("Error creating notification for enrollment (vnpay): " . $e->getMessage());
                }
            }
